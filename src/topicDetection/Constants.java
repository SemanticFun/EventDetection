...
/**
 * Class to manage the configurazion constants,
 * useful to classify the documents.
 * 
 */
public class Constants {
	 ...
	 * Constructor
	 * 
	 * @param constantsFile	the name of the input file containing the configuration parameters
	 * @throws Exception
	 */
	...
	public double HASHTAG_WEIGHT = 2;
	...
	/**
	 * Reads the configuration parameters contained in the input file.
	 * 
	 * @param in	file containing the configuration parameters
	 * @throws Exception
	 */
	public void load(DataInputStream in) throws Exception {
		...
		HASHTAG_WEIGHT = Double.parseDouble(conf.get("HASHTAG_WEIGHT"));
