...
public class Edge {
	...
	/**
	 * Compute the conditional probability of an edge, 
	 * that is the probability of seeing node i in a 
	 * document if node j exists in the document.
	 */
	 ...
	 * document if node j exists in the document.
	 */
	public void computeCPsLink() {
		cp1 = 2.0 * df / n1.keyword.tf;
		cp2 = 2.0 * df / n2.keyword.tf;
	}
