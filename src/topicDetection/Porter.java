...
/**
 * Class for the management of a stemmer.
 * 
 */
public class Porter {

	/**
	 * Removes any character other than a letter or a digit.
	 * 
	 * @param str	word contained in the news'text
	 * @return		word without characters other than letters or digits
	 */
	...
	/**
	 * Removes prefixes from news'text.
	 * 
	 * @param str	word contained in news'text
	 * @return		word without prefixes
	 */
	private String stripPrefixes(String str) {
		String[] prefixes = { "kilo", "micro", "milli", "ultra", "mega", "nano", "pico", "pseudo", 
				"iper", "arci", "ante"};
	...
	/**
	 * Stems the root of the word 'str'.
	 * 
	 * @param str	word contained in news'text
	 * @return		stemmed word (the root of the word)
	 */
	...
	/**
	 * Strips prefixes and suffixes of the word.
	 * 
	 * @param str	a word of the news'text
